...
#Task 7, splitting this into two parts, 
#The first part is plotting the bar charts:
...
#The second part is determining if there is a correlation between user_ID & component
